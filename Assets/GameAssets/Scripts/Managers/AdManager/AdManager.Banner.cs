...
namespace com.tinycastle.StickerBooker
{
    public partial class AdManager
    {
        ...
        {
            MaxSdk.SetBannerBackgroundColor(BANNER_AD_UNIT, BANNER_COLOR_CHRISTMAS);
        }
        ...
        {
            Log.Warn($"OnBannerAdLoadFailedEvent, reason: {errorInfo.Message}");
        }
        
        private void OnBannerAdClickedEvent(string adUnitId, MaxSdkBase.AdInfo adInfo)
        {
            Log.Info("OnBannerAdClickedEvent");
        }
        
        private void OnBannerAdExpandedEvent(string adUnitId, MaxSdkBase.AdInfo adInfo)
        {
            Log.Info("OnBannerAdExpandedEvent");
        }
        
        private void OnBannerAdCollapsedEvent(string adUnitId, MaxSdkBase.AdInfo adInfo)
        {
            Log.Info("OnBannerAdCollapsedEvent");
        }
        //
        // private void OnAdRevenuePaidEvent(string adUnitId, MaxSdkBase.AdInfo adInfo)
        // {
        //     Log.Info($"OnAdRevenuePaidEvent, Id: {adInfo.AdUnitIdentifier}, Info: {adInfo.Placement}. Rev: {adInfo.Revenue}");
        //     
        //     GM.Instance.Events.MakeEvent(GameEvents.AD_IMPRESSION_OR_REVENUE)
        //         .Add("revenue", adInfo.Revenue)
        //         .Add("placement", adInfo.Placement)
        //         .Add("id", adInfo.AdUnitIdentifier)
        //         .SendEvent();
        // }
    }
}